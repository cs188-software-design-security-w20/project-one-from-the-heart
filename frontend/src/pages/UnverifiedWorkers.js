...
class UnverifiedWorkers extends Component {
    constructor() {
        super();
    ...
    verifyUser(e) {
        ...
        axios({
            method: "post",
            url: "https://us-central1-maintenance-genie.cloudfunctions.net/api/verify_worker/"+value,
            headers: {
                "Authorization": "Bearer " + window.sessionStorage.token,
                "Content-Type": "application/json"
            }
            ...
            switch (res.status) {
                case 200:
                    window.sessionStorage.setItem("error", "alert success: Worker verified.");
...
export default UnverifiedWorkers;